...
class DepthDecoder(nn.Module):
    def __init__(self, 
        ...
        # self.convs["f0"] = Attention_Module(self.ch_enc[0]  , num_ch_enc[0]) # for mpbase
    ...
    def forward(self, input_features):
        ...
        # feat[0] = self.convs["f0"](input_features[0]) # for mpbase
        feat[0] = input_features[0] # for mpsmall
